...
![img](https://doc.shiyanlou.com/document-uid214893labid7506timestamp1534942536511.png)
...
`matplotlib.pyplot.plot(*args, **kwargs)` 方法严格来讲可以绘制线形图或者样本标记。其中，`*args` 允许输入单个 𝑦 值或 𝑥,𝑦值。

例如，我们这里绘制一张自定义 𝑥,𝑦 的正弦曲线图。
...
尝试通过 Matplotlib 绘制出下图这副图像，你可能需要结合 [ *官方文档*](https://matplotlib.org/api/index.html) 来查找合适的方法。

![图片描述](https://doc.shiyanlou.com/courses/uid214893-20190524-1558684935104)

```
# 欢迎通过实验报告分享你的解答过程
```

[ *参考答案*](https://labfile.oss.aliyuncs.com/courses/892/sin_cos_functions.py)

### 实验总结

通过这节实验课程的学习，相信你已经初步掌握了使用 Matplotlib 绘图的方法和技巧。当然，如果你对 Matplotlib 非常感兴趣，也可以通过蓝桥云课其他课程学习 Matplotlib 的更多内容。